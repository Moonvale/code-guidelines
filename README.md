# 🌙 Moonvale Code Guidelines

At Moonvale, we strictly adhere to the [Diktat Code Style](https://github.com/saveourtool/diktat).
Any code that is going to be deployed into production has to pass this Linter first! Therefore every plugin repository MUST contain a workflow automatically executing the Diktat checks!

## 📚 Coding Style Guide (Diktat Code Style), v.1.0.0

The following section is copied from the [Diktat Repository README.md](https://github.com/saveourtool/diktat):
